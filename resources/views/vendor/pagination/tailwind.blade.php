    ...
    @if ($paginator->hasPages())
        <div class="pagination-controls">
            ...
            @if ($paginator->onFirstPage())
                <span class="pagination-btn pagination-btn-disabled" aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
            ...
            @else
                <span class="pagination-btn pagination-btn-disabled" aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="9 18 15 12 9 6"></polyline>
                    </svg>
                </span>
