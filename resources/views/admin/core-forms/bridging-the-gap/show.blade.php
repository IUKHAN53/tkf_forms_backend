...
<div class="content-card">
    ...
    // Canonical action-plan columns, in display order. The manage-modal table,
    // its inline editor and the save payload are all driven off this list, so
    // adding a column here is the only change needed. Keep in sync with
    // BridgingTheGapController::resolveActionPlanColumns() and the sample
