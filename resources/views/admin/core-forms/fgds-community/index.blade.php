...
<div class="content-card" style="margin-bottom: 20px;">
    ...
    <div class="barriers-category-grid" id="barriersCategoryGrid" data-barriers-url="{{ url('admin/fgds-community/barriers-by-category') }}">
    ...
    <div class="card-filters">
        <form action="{{ route('admin.fgds-community.index') }}" method="GET" class="filter-form">
            ...
            <div class="filter-row">
                ...
                @if(request()->hasAny(['search', 'district', 'uc', 'fix_site', 'date_from', 'date_to', 'facilitator']))
            ...
            <div class="modal-body">
                ...
                <div style="background: #e0f2fe; border: 1px solid #7dd3fc; border-radius: 8px; padding: 12px; margin-bottom: 16px;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <a href="{{ route('admin.fgds-community.barriers-sample') }}" class="btn btn-sm btn-info" style="margin-left: auto;">
