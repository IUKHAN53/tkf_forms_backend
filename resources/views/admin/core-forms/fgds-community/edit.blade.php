...
@section('title', 'Edit FGDs-Community')
...
<div class="content-card">
    <div class="card-header">
        <div class="header-left">
            <h2>Edit FGDs-Community <code>{{ $fgdsCommunity->unique_id }}</code></h2>
            <p class="text-muted">Update session details</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.fgds-community.show', $fgdsCommunity) }}" class="btn btn-outline">
    ...
    <form action="{{ route('admin.fgds-community.update', $fgdsCommunity) }}" method="POST" class="edit-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="date" id="date" name="date" class="form-input @error('date') is-invalid @enderror"
                       value="{{ old('date', $fgdsCommunity->date?->format('Y-m-d')) }}" required>
                @error('date')
            ...
            <div class="form-group">
                ...
                <input type="text" id="district" name="district" class="form-input @error('district') is-invalid @enderror"
                       value="{{ old('district', $fgdsCommunity->district) }}" required>
                @error('district')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="uc" name="uc" class="form-input @error('uc') is-invalid @enderror"
                       value="{{ old('uc', $fgdsCommunity->uc) }}" required>
                @error('uc')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="fix_site" name="fix_site" class="form-input @error('fix_site') is-invalid @enderror"
                       value="{{ old('fix_site', $fgdsCommunity->fix_site) }}">
                @error('fix_site')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="venue" name="venue" class="form-input @error('venue') is-invalid @enderror"
                       value="{{ old('venue', $fgdsCommunity->venue) }}" required>
                @error('venue')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="facilitator_tkf" name="facilitator_tkf" class="form-input @error('facilitator_tkf') is-invalid @enderror"
                       value="{{ old('facilitator_tkf', $fgdsCommunity->facilitator_tkf) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="facilitator_govt" name="facilitator_govt" class="form-input @error('facilitator_govt') is-invalid @enderror"
                       value="{{ old('facilitator_govt', $fgdsCommunity->facilitator_govt) }}">
            ...
            <div class="form-group">
                ...
                <input type="number" id="participants_males" name="participants_males" class="form-input @error('participants_males') is-invalid @enderror"
                       value="{{ old('participants_males', $fgdsCommunity->participants_males) }}" min="0" required>
            ...
            <div class="form-group">
                ...
                <input type="number" id="participants_females" name="participants_females" class="form-input @error('participants_females') is-invalid @enderror"
                       value="{{ old('participants_females', $fgdsCommunity->participants_females) }}" min="0" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="latitude" name="latitude" class="form-input @error('latitude') is-invalid @enderror"
                       value="{{ old('latitude', $fgdsCommunity->latitude) }}" placeholder="e.g., 24.8607">
                @error('latitude')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="longitude" name="longitude" class="form-input @error('longitude') is-invalid @enderror"
                       value="{{ old('longitude', $fgdsCommunity->longitude) }}" placeholder="e.g., 67.0011">
                @error('longitude')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('admin.fgds-community.show', $fgdsCommunity) }}" class="btn btn-outline">Cancel</a>
        </div>
    </form>
</div>
