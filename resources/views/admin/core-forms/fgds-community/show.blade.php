    ...
    @if($fgdsCommunity->barriers && $fgdsCommunity->barriers->count() > 0)
        <div class="barriers-section" style="margin-top: 24px;">
            ...
            <table class="data-table">
                ...
                <tbody>
                    @foreach($fgdsCommunity->barriers->sortBy('serial_number') as $barrier)
                        <tr>
